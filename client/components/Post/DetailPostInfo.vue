  ...
  <div class="DetailPostInfoContainer" @click.stop="">
    ...
    <div class="DetailPostInfoBox" v-if="Post">
      ...
      <div class="Status">
        ...
        <div class="LikeCount">
          <span><span class="count">{{Post.likes.length}}</span> Like</span>
        </div>
      ...
      <div class="BoxReplyContainer" v-if="loginedUser">
        ...
        <div class="EditerContainer">
          <div class="Editer" default-txt="Push your reply" contenteditable @focus="editerFocusEventHandler" @blur="editerBlurEventHandler" @input="editerInputEventHandler"></div>
...
export default {
  ...
  computed: {
    ...
    RegPostDate: function () {
      ...
      return date => moment(date).format('a h:m - YYYY year M month D day')
    },
    RegCommentDate() {
      return date => moment(date).format('YYYY year M month D day')
    },
